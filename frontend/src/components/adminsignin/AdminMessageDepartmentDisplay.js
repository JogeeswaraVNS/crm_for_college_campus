...
function AdminMessageDepartmentDisplay(props) {
  ...
  function PostEditedComplaint(event){
    console.log(Message)
    axios.put(`http://127.0.0.1:5000/admin/put/message/department/${AdminID}/${Department}/${ID}/`,Message)
  ...
  function DeletePostedComplaint(event){
    ...
    axios.delete(`http://127.0.0.1:5000/admin/message/department/${AdminID}/${Department}/${ID}/`,Message)
  ...
  let [Dept,setDept]=useState(props.Department)

  let [sort,setsort]=useState(false)


  useEffect(()=>{
      axios.get(`http://127.0.0.1:5000/get/admin/message/department/${props.AdminID}/${props.Department}/${sort}/`)
      .then(r=>setData(r.data))
      .catch(err=>console.log(err))
      }

      //dependency array
      ,[props.Department,sort]);
...
<div>
            ...
            <textarea 
                ...
                value={Message.Body} onChange={EditComplaint}
                >
            </textarea>
...
<h6 className='ms-2 d-inline'>Cancel</h6>
                ...
                <button className='btn btn-success mb-3' onClick={PostEditedComplaint} type='button'>
...
<div className='col mt-2'>
        <h5 className=''>You have Posted {Data.length} Message(s)</h5>
</div>

<div className='col mt-2'>

<h5>          Department Messages
       <span>
      <svg xmlns="http://www.w3.org/2000/svg" className='mb-1 ms-2' fill='#ffc107'  height="25" viewBox="0 0 512 512"><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
...
<label htmlFor="check" className="">
  ...
  Latest first
      ...
      <h5 className='mb-4 mt-2 fw-semibold'>Viewing <span className='text-danger'>{props.Department}</span> Department Messages posted by you. Edit or delete your previously posted Messages here</h5>

        {   

        Data.length===0?
        <div>
          <h4 className='department'>No Messages By you to {props.Department} Department. Post your Messages in Post Message.</h4>
        </div>:
            ...
            <tbody>
                {
                    Data.map((d)=>(
                        <tr key={d.id}>
                            ...
                            <td style={{width:'50%'}} className='p-3'><h5>{d.message}</h5></td>
...
export default AdminMessageDepartmentDisplay