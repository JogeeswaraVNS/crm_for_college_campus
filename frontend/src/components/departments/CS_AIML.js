...
<div style={{width:'40rem',display:'block',margin:'auto',backgroundColor:'#82001a'}}>
    ...
    <div class="col p-0">
    <img src={aiml1} width="100%" alt="this image is not available"></img>
    </div>
