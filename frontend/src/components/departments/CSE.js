...
<h3 style={{width:'31rem',display:'block',margin:'auto',backgroundColor:'#82001a',borderRadius:''}} className='py-2 text-white my-4'>Computer Science and Engineering</h3>
...
<div class="col p-0">
                        <img src={cse1} width="100%" alt="this image is not available"></img>                     
</div>
