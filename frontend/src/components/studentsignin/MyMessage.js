...
function MyMessage(props) {
  ...
  useEffect(()=>{
      ...
      axios.get(`http://127.0.0.1:5000/get/admin/message/student/${props.Rollno}/${sort}/`)
...
<label htmlFor="check" className="ms-1">
  ...
  Latest first
      ...
      <h4 className='mb-4 mt-2 fw-semibold'>Viewing Messages posted by Admins to You</h4>

      {   

Data.length===0?
<div>
  <h2 className='department'>No Messages By Admins to You.</h2>
</div>:
