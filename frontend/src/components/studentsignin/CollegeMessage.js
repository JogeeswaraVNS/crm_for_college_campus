...
function CollegeMessage() {
  ...
  useEffect(()=>{
    axios.get(`http://127.0.0.1:5000/get/admin/message/clg/${sort}/`)
...
<label htmlFor="check" className="ms-1">
  ...
  Latest first
      ...
      <h4 className='mb-4 mt-2 fw-semibold'>Viewing Messages posted by Admin</h4>
